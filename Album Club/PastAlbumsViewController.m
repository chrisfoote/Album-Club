...
#import "PastAlbumsViewController.h"
#import "CJSONDeserializer.h"

@implementation PastAlbumsViewController
@synthesize tv;
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.myalbumclub.co.uk/webservices/allpast"]];
